  ...
  return (
    <aside className={`sidebar ${collapsed?'collapsed':''}`}>
      ...
      <div className="sidebar-footer">
        <button className="nav-item" style={{background:'none',border:'none',cursor:'pointer',width:'100%'}} title="Logout" onClick={()=>{ localStorage.removeItem('hrms_access_token'); localStorage.removeItem('hrms_refresh_token'); localStorage.removeItem('hrms_user'); document.cookie='hrms_access_token=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT'; document.cookie='hrms_token=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT'; document.cookie='hrms_role=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT'; window.location.href='/login'; }}>
